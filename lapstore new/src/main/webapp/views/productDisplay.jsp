...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <p class="lead">Lapstore</p>
                <div class="list-group">
                    <a href=categoryDropdown/productDisplay/140" class="list-group-item">Apple</a>
                    <a href="categoryDropdown/productDisplay/140171" class="list-group-item">HP</a>
                    <a href="categoryDropdown/productDisplay/142" class="list-group-item">Acer</a>
                    <a href="categoryDropdown/180" class="list-group-item">Dell</a>
                    <a href="categoryDropdown/productDisplay/142143" class="list-group-item">Lenovor</a>
                </div>
            </div>
   <div class="col-md-9">
